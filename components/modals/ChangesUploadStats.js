...
const ChangesUploadStats = () => {

    const { t: translate } = useTranslation();
    const { uploadStats: { show, data } } = useChangesCtx()
            ...
            >
                <Box sx={{
                    ...
                    <Typography fontSize={16}>
                        {translate("TOTAL_CHANGES_ADDED")}: {data?.totalChangesAdded || 0}
                    </Typography>
                    <Typography fontSize={16}>
                        {translate("TOTAL_OPTIONS_ADDED")}: {data?.totalRowsAdded || 0}
                    </Typography>
                    <Typography fontSize={16}>
...
export default ChangesUploadStats